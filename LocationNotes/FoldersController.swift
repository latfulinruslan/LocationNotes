...
class FoldersController: UITableViewController {
    ...
    @IBAction func pushAddAction(_ sender: Any) {
        ...
        let alertActionAdd = UIAlertAction(title: "Create", style: UIAlertActionStyle.default) { (alert) in
        ...
        let AlertActionCancel = UIAlertAction(title: "Cancel", style: UIAlertActionStyle.default) { (alert) in
        }
